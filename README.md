...
## AIM
   To design a Webpage using JavaScript eith a minimum of five mathematical operations.
## PROGRAM
### calc.html
```
...
body {
    ...
    align-items: center;
    height: 100vh;
    background: linear-gradient(to right, #6b6bc4, #220722);
    margin: 0;
...
```
## OUTPUT
![Screenshot (157)](https://github.com/user-attachments/assets/43ba13b9-cd96-49a7-86a4-e41f26bfaec6)
